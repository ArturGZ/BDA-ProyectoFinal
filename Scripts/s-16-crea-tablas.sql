...
Prompt Creando la tabla admin_subastas.categoria
CREATE TABLE ADMIN_SUBASTAS.CATEGORIA(
...
Prompt Creando la tabla admin_subastas.status_producto
CREATE TABLE ADMIN_SUBASTAS.STATUS_PRODUCTO(
...
Prompt Creando la tabla admin_subastas.producto
CREATE TABLE ADMIN_SUBASTAS.PRODUCTO(
    ...
    REFERENCES ADMIN_SUBASTAS.STATUS_PRODUCTO(STATUS_PRODUCTO_ID)
    USING INDEX TABLESPACE SUBASTAS_INDICES_TBS,
    CONSTRAINT CATEGORIA_CATEGORIA_ID_FK FOREIGN KEY (CATEGORIA_ID)
    REFERENCES ADMIN_SUBASTAS.CATEGORIA(CATEGORIA_ID)
    USING INDEX TABLESPACE SUBASTAS_INDICES_TBS
) TABLESPACE SUBASTAS_TABLAS_TBS;

Prompt Creando la tabla admin_subastas.evaluacion_producto
CREATE TABLE ADMIN_SUBASTAS.EVALUACION_PRODUCTO(
    ...
    REFERENCES ADMIN_SUBASTAS.PRODUCTO(PRODUCTO_ID)
    USING INDEX TABLESPACE SUBASTAS_INDICES_TBS
) TABLESPACE SUBASTAS_TABLAS_TBS;
...
Prompt Creando la tabla admin_subastas.galeria
CREATE TABLE ADMIN_SUBASTAS.GALERIA(
...
Prompt Creando la tabla admin_subastas.historico_status_producto
CREATE TABLE ADMIN_SUBASTAS.HISTORICO_STATUS_PRODUCTO(
...
Prompt Creando la tabla admin_subastas.subasta
CREATE TABLE ADMIN_SUBASTAS.SUBASTA(
...
Prompt Creando la tabla admin_subastas.oferta
CREATE TABLE ADMIN_SUBASTAS.OFERTA(
    ...
    REFERENCES ADMIN_SUBASTAS.SUBASTA(SUBASTA_ID)
    USING INDEX TABLESPACE SUBASTAS_INDICES_TBS
) TABLESPACE SUBASTAS_TABLAS_TBS;